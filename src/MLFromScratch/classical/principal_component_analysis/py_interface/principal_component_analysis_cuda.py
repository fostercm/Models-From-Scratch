...
class PCACUDA(PCABase):
    ...
    def __init__(self):
        ...
        lib_path = os.path.join(package_dir, "../../../lib/libprincipal_component_analysis_cuda.so")
    ...
    def transform(self, X: np.ndarray, n_components: int=None, explained_variance_ratio: float=None) -> np.ndarray:
        ...
        X_transformed = X_transformed.reshape(n_output_components, n_samples).T
