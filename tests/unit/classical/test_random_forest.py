...
class TestRandomForest(unittest.TestCase):
    ...
    def test(self):
        ...
        X_cla, y_cla = make_classification(n_samples=500, n_features=3, n_classes=3, 
                            n_clusters_per_class=1, n_redundant=0, 
                            n_informative=2, class_sep=6, random_state=42)
        
        X_reg, Y_reg = make_regression(n_samples=500, n_features=3, n_targets=2, 
        ...
        for model in [
            RandomForest(language='Python', task='regression', n_trees=5, max_depth=5),
        ]:
            # Fit the model to the data
